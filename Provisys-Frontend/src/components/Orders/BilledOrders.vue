...
const handleDeliverOrder = () => {
    confirmation("Alerta", "¿Está seguro de que desea entregar el pedido",
        () => {
            successNotification("Pedido entregado exitosamente");
        },
        () => { }
    )
}
        ...
        <el-dialog v-model="isSelectedOrder" title="Detalles del Pedido" width="80%" @close="selectedOrder = null"
            ...
            <template #footer>
                <div class="dialog-footer flex justify-end flex-wrap gap-4 gap-y-2">
                    ...
                    <el-button class="!ml-0" v-if="!selectedOrder.payment.verified" type="primary" :disabled="fetchingModal"
                        @click="handleConfirmPayment">
                        Confirmar Pago
                    </el-button>
                    <el-button class="!ml-0" type="success" :disabled="fetchingModal" @click="handleDeliverOrder">
                        Entregar Pedido
                    </el-button>
                </div>
            </template>
