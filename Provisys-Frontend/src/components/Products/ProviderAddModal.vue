...
<template>
    <el-dialog title="Nuevo Proveedor" width="80%" @close="() => { $emit('closeModal') }" :fullscreen="fullScreenModals"
        class="!p-6">
        <!-- Modal Content -->
            ...
            <div class="w-full flex flex-col md:flex-row gap-4 mt-4" v-loading="fetchingModal">
                <el-form label-position="top" class="w-full">
                    <el-form-item label="Cédula o RIF">
                        <el-input v-model="provider.id" />
                    </el-form-item>
                    <el-form-item label="Nombre">
                        <el-input v-model="provider.name" />
                    </el-form-item>
                    <el-form-item label="Teléfono">
                        <el-input v-model="provider.phone" />
                    </el-form-item>
                    <el-form-item label="Correo Electrónico">
                        <el-input v-model="provider.email" />
                    </el-form-item>
                    <el-form-item label="Dirección">
                        <el-input v-model="provider.address" />
                    </el-form-item>
                </el-form>
            </div>
        </Transition>
