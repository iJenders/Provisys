...
-- Dumping data for table provisys.rol: ~2 rows (approximately)
...
INSERT INTO `usuario` (`nombre_usuario`, `fecha_registro`, `nombres`, `apellidos`, `correo`, `telefono`, `telefono_secundario`, `direccion`, `verificado`, `id_rol`) VALUES
	('admin', '2025-06-11 19:01:47', 'Admin', 'User', 'admin@example.com', '1234567890', '+584125372035', '123 Main St', 1, 1),
